import sqlite3, math, js2py, os, requests, models.bloodBowl as models, datetime, crud, constants.dictionaries as dictionaries
class GoblinSpy:
    ...
    def read_tournament(self, json, discord_server_id):
        ...
        if league:
            ...
            for team_data in ranking_data:
                ...
                team = models.Team(coach = coach, team_name=team_data[17], race=dictionaries.get_race_emoji(int(team_data[16])), wins=team_data[22], draws=team_data[23], loses=team_data[24], rank=team_data[18], td=team_data[25])
